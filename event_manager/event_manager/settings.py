...
SECRET_KEY = 'k(%2w0y44@g5_x*0#rzzu!_v)+dk+(r_f%n5z%vibtde7hs*it'
...
REST_FRAMEWORK = {
    ...
    # 'EXCEPTION_HANDLER': 'event_manager/events/utils/custom_exception_handler'
...
# NOSE_ARGS = [
#     '--with-coverage',
#     '--cover-package=events,event_manager',
# ]
